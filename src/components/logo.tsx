...
export default function Logo({ className = 'h-9', iconOnly = false }: LogoProps) {
    ...
    return (
      <div className={className}>
        <svg viewBox="0 0 40 32" fill="none" className="h-full w-auto" xmlns="http://www.w3.org/2000/svg">
          ...
          <path d="M4 28L20 12L36 28" stroke="currentColor" strokeWidth="5" strokeLinecap="round" strokeLinejoin="round" />
        </svg>
      </div>
    )
  }
  ...
  return (
    <div className={`flex items-center gap-1.5 ${className}`}>
      <svg viewBox="0 0 40 32" fill="none" className="h-5 w-auto" xmlns="http://www.w3.org/2000/svg">
        ...
        <path d="M4 28L20 12L36 28" stroke="#10B981" strokeWidth="5" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
